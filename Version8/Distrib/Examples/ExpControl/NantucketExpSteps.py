...
if __name__ == '__main__':
  ...
  fig.suptitle ('Nantucket Steps with ExpControl', fontsize=10)

  ax[0].plot (t, monitors['pcc1vi']['V'], label='FL V', linestyle='-', color='red')
  ax[0].plot (t, monitors['pcc2vi']['V'], label='NL V', linestyle='--', color='blue')
  ax[0].plot (t, monitors['pv1st']['Vreg'], label='FL Vreg', linestyle='-.', color='magenta')
  ax[0].plot (t, monitors['pv2st']['Vreg'], label='NL Vreg', linestyle=':', color='green')
